...
local function findPlayer(searchString)
   ...
   searchString = convertToString(searchString)
   ...
   for _, player in pairs(players) do
      ...
      if lowerName:sub(1, #lowerSearchString) == lowerSearchString or
         lowerDisplayName:sub(1, #lowerSearchString) == lowerSearchString then
...
function sendMsg(text)
   ...
   properties.Text = convertToString
